...
export default class MapContainer extends React.Component {
    ...
    constructor(props, context) {
        ...
        this.state = {
            ...
            areas: {
                ...
                BE: {
                    fullName: 'Бельгия',
                    relating: ['world', 'europe']
                },
                BF: {
                    fullName: 'Буркина-Фасо',
                    relating: ['world', 'africa']
                },
                BG: {
                    fullName: 'Болгария',
                    relating: ['world', 'europe']
                ...
                JM: { fullName: 'Ямайка', relating: ['world']},
                BW: {
                    fullName: 'Ботсвана',
                    relating: ['world', 'africa']
                },
                BR: { fullName: 'Бразилия', relating: ['world']},
                BS: { fullName: 'Багамы', relating: ['world']},
                BY: {
                    fullName: 'Беларусь',
                    relating: ['world', 'europe']
                },
                BZ: { fullName: 'Белиз', relating: ['world']},
                RU: {
                    fullName: 'Россия',
                    relating: ['world', 'europe']
                },
                ...
                GW: {
                    fullName: 'Гвинея-Бисау',
                    relating: ['world', 'africa']
                },
                GT: {
                    fullName: 'Гватемала',
                    relating: ['world', 'c-america']
                },
                GR: {
                    fullName: 'Греция',
                    relating: ['world', 'europe']
                ...
                GQ: {
                    fullName: 'Экваториальная Гвинея',
                    relating: ['world', 'africa']
                },
                GY: {
                    fullName: 'Гайана',
                ...
                GB: {
                    fullName: 'Соединенное Королевство',
                    relating: ['world', 'europe']
                },
                GA: {
                    fullName: 'Габон',
                ...
                GH: { fullName: 'Гана', relating: ['world', 'africa']},
                OM: {
                    fullName: 'Оман',
                    relating: ['world', 'asia'],
                ...
                HT: { fullName: 'Гаити', relating: ['world']},
                HU: {
                    fullName: 'Венгрия',
                    relating: ['world', 'europe']
                },
                HN: {
                    fullName: 'Гондурас',
                    relating: ['world', 'america']
                },
                LV: {
                    fullName: 'Латвия',
                    relating: ['world', 'europe']
                },
                PR: { fullName: 'Пуэрто-Рико', relating: ['world']},
                PS: {
                    fullName: 'Палестинская территория',
                    relating: ['world', 'asia'],
                ...
                ZA: { fullName: 'ЮАР', relating: ['world', 'africa']},
                EC: {
                    fullName: 'Эквадор',
                    relating: ['world', 's-america']
                },
                ...
                ML: { fullName: 'Мали', relating: ['world', 'africa']},
                MN: {
                    fullName: 'Монголия',
                    relating: ['world', 'asia'],
                ...
                CU: { fullName: 'Куба', relating: ['world']},
                SZ: {
                    fullName: 'Свазиленд',
                    relating: ['world', 'africa']
                },
                ...
                TG: { fullName: 'Того', relating: ['world', 'africa']},
                TD: { fullName: 'Чад', relating: ['world', 'africa']},
                LY: {
                    fullName: 'Ливийская Арабская Джамахирия',
                    relating: ['world', 'africa']
                },
                AE: {
                ...
                VE: {
                    fullName: 'Венесуэла Боливарианская Республика',
                    relating: ['world', 's-america']
                },
                AF: {
                    fullName: 'Афганистан',
                ...
                FM: {
                    fullName: 'Микронезия, Федеративные Штаты',
                    relating: ['world', 'oceania'],
    ...
    filterAreasByMapType(type) {
        ...
        for (let area in this.state.areas) {
            ...
            if (this.state.areas[area].relating.includes(type)) {
                currentAreas[area] = this.state.areas[area];
            }
        }
